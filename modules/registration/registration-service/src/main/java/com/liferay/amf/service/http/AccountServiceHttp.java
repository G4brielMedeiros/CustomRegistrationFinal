...
public class AccountServiceHttp {
	...
	public static com.liferay.amf.model.Account addAccount(
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				...
				male, birthday, password, homePhone, mobilePhone, address1,
				address2, city, state, zipCode, securityQuestion,
				securityAnswer, acceptTerms);
			...
			return (com.liferay.amf.model.Account)returnObj;
		}
