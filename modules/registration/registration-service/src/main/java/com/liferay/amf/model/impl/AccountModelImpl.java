...
/**
 * The base model implementation for the Account service. Represents a row in the &quot;Account_Account&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class AccountModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"modifiedDate", Types.TIMESTAMP}, {"homePhone", Types.VARCHAR},
		...
		{"securityQuestion", Types.INTEGER}, {"securityAnswer", Types.VARCHAR},
		{"acceptedTerms", Types.BOOLEAN}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("securityQuestion", Types.INTEGER);
		TABLE_COLUMNS_MAP.put("securityAnswer", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("acceptedTerms", Types.BOOLEAN);
	}

	public static final String TABLE_SQL_CREATE =
		"create table Account_Account (uuid_ VARCHAR(75) null,accountId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,homePhone VARCHAR(75) null,mobilePhone VARCHAR(75) null,address1 VARCHAR(75) null,address2 VARCHAR(75) null,city VARCHAR(75) null,state_ VARCHAR(75) null,zipCode VARCHAR(75) null,securityQuestion INTEGER,securityAnswer VARCHAR(75) null,acceptedTerms BOOLEAN)";

	public static final String TABLE_SQL_DROP = "drop table Account_Account";

	public static final String ORDER_BY_JPQL =
		" ORDER BY account.accountId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Account_Account.accountId ASC";
	...
	static {
		...
		attributeSetterBiConsumers.put(
			"securityQuestion",
			(BiConsumer<Account, Integer>)Account::setSecurityQuestion);
		attributeGetterFunctions.put(
		...
		attributeGetterFunctions.put(
			"acceptedTerms", Account::getAcceptedTerms);
		attributeSetterBiConsumers.put(
			"acceptedTerms",
			(BiConsumer<Account, Boolean>)Account::setAcceptedTerms);
	...
	public Object clone() {
		...
		accountImpl.setAcceptedTerms(isAcceptedTerms());
	...
	public Account cloneWithOriginalValues() {
		...
		accountImpl.setSecurityQuestion(
			this.<Integer>getColumnOriginalValue("securityQuestion"));
		accountImpl.setSecurityAnswer(
			this.<String>getColumnOriginalValue("securityAnswer"));
		accountImpl.setAcceptedTerms(
			this.<Boolean>getColumnOriginalValue("acceptedTerms"));
	...
	public CacheModel<Account> toCacheModel() {
		...
		accountCacheModel.acceptedTerms = isAcceptedTerms();
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("acceptedTerms", _acceptedTerms);
	}
	...
	static {
		...
		columnBitmasks.put("homePhone", 128L);

		columnBitmasks.put("mobilePhone", 256L);

		columnBitmasks.put("address1", 512L);

		columnBitmasks.put("address2", 1024L);

		columnBitmasks.put("city", 2048L);

		columnBitmasks.put("state_", 4096L);

		columnBitmasks.put("zipCode", 8192L);

		columnBitmasks.put("securityQuestion", 16384L);

		columnBitmasks.put("securityAnswer", 32768L);

		columnBitmasks.put("acceptedTerms", 65536L);
